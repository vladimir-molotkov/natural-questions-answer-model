...
## Данные
В данной работе используется датасет Natural Questions от Google Research [Hugging Face link](https://huggingface.co/datasets/google-research-datasets/natural_questions).
